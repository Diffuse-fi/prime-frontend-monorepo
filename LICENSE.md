...
- `indexer/` — Apache License 2.0. See [indexer/LICENSE](indexer/LICENSE) and [indexer/NOTICE](indexer/NOTICE).
- `config/` — Apache License 2.0. See [config/LICENSE](config/LICENSE) and [config/NOTICE](config/NOTICE).
